...
handoffs:
  - label: Update Project Constitution
    agent: speckit.constitution
    prompt: Codify the identified principles and governance rules into the project constitution.
  - label: Build Technical Plan
    agent: speckit.plan
    prompt: Create a technical implementation plan for improvements identified in docs.md.
    send: true
---
